    ...
    <div class="form-box box">
      ...
      <form action="#" method="POST">
        ...
        <p>This email is used, Try another One Please!</p>
              ...
              if ($pass === $cpass) {
                ...
                $sql = "insert into users(username,email,password,gender, age, batch) values('$name','$email','$passwd','$gender','$age','$batch')";
      ...
      <p>Password does not match.</p>
            ...
            <div class="input-container">
              ...
              <input class="input-field" type="number" placeholder="age" name="age" required min="18" max="65" >
            </div>
